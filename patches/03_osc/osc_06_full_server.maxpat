...
,
					"patching_rect" : [ 739.0, 696.0, 63.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1077.0, 326.932372999999984, 366.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1077.0, 40.5, 48.0, 19.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1168.0, 398.5, 91.0, 22.0 ],
					"text" : "shell"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 54.168503000000001, 24.0, 34.0, 27.0 ],
					"text" : "osc",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.5, 37.75, 43.875, 16.950928000000001 ],
					"saved_attribute_attributes" : 					{
						"linecolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 9.168502999999999, 10.96936, 81.0, 15.716751 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 474.0, 125.5, 216.0, 27.0 ],
					"text" : "Downlink"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 623.5, 282.0, 74.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 623.5, 313.0, 128.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 623.5, 249.0, 68.0, 22.0 ],
					"text" : "route /print"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 423.0, 260.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 474.0, 249.0, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlinecolor" : [ 1.0, 1.0, 1.0, 0.0 ],
					"parameter_enable" : 0,
					"patching_rect" : [ 579.5, 249.0, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 474.0, 170.0, 92.0, 22.0 ],
					"text" : "r #0-port_out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 474.0, 201.0, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.168503, 1.087875, 147.0, 63.787125000000003 ],
					"proportion" : 0.39,
					"rounded" : 16
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 483.5, 235.0, 589.0, 235.0 ],
					"order" : 1,
					"source" : [ "obj-142", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 483.5, 235.0, 633.0, 235.0 ],
					"order" : 0,
					"source" : [ "obj-142", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../acids/flow_synthesizer/plugin",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../../../acids/flow_synthesizer/plugin/graphics/icons_white_50",
				"type" : "PNG",
				"implicit" : 1
			}
, 			{
